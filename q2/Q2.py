...
df1 = pd.read_csv('l_class1.txt', sep=' ')
df2 = pd.read_csv('l_class2.txt', sep=' ')
df3 = pd.read_csv('l_class3.txt', sep=' ')
...
ans_linear=pd.DataFrame(ans_linear,columns=["Acc.","Prec.","Recall","F-score"])
ans_linear['id']=["C1","C2",'C3','c4']
ans_linear.set_index('id', inplace=True )
print(ans_linear)
